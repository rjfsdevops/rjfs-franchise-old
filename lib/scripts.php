...
{
    wp_enqueue_style('roots_main', get_template_directory_uri() . '/assets/css/main.min.css', false, 'd60ddaf956c7f09b4d1572db747a00c4');
    ...
    wp_register_script('roots_scripts', get_template_directory_uri() . '/assets/js/scripts.min.js', array(), '01c2e59c7f2363f43fccde27541524e8', true);
...
function roots_admin_scripts()
{
    ...
    if ($post->post_type == 'list') {
        wp_register_script('rjfs-admin', get_template_directory_uri() . '/assets/js/admin/rjfs-admin.js', array(), null, false);
        wp_enqueue_script('rjfs-admin');
    }
}
